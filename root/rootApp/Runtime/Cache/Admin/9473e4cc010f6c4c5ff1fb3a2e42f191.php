 ...
 <div class="navbar navbar-fixed-top navbar-inverse" role="navigation">
    ...
    <div style="width:300px">
		<ul class="nav nav-pills nav-stacked">
		   ...
		   <li class="active"><a href="<?php echo U('Index/managers');?>">Managers</a></li>
		</ul>
	</div>
  <br><br><button type="button" class="btn btn-warning" ><a href="<?php echo U('Managers/add');?>">添加管理者<a></button>
  </div>
  <br><br>
   <table class="table table-hover" >
   <caption>管理者列表</caption>
   <thead>
      <tr>
         <th>name</th>
         <th>权限</th>
   ...
   <tbody>
      <?php if(is_array($data)): foreach($data as $key=>$d): ?><tr>
             ...
             <td>管理新闻和读者</td>
              <td><a href="<?php echo U('Admin/Managers/del');?>&id=<?php echo ($d["id"]); ?>">删除</a></td>
